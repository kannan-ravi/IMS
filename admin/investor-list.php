                ...
                <tr>
                  ...
                  <td>
                    <div class="custom-table-action">
                      <i class="fas fa-edit custom-table-icon" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
            ...
            <form id="editForm" action="update-user.php" method="POST">
              ...
              <div class="row">
                <div class="col-sm-6 mt-3">
                  <input type="text" class="form-control" placeholder="Name" name="f_name" id="editFName"
                    aria-label="Name" />
                </div>
                <div class="col-sm-6 mt-3">
                  <input type="text" class="form-control" name="investor_id" id="editInvestorId"
                    placeholder="Investor ID" aria-label="Investor ID" />
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6 mt-3">
              ...
              <div class="row">
                <div class="col-sm-6 mt-3">
                  <input type="text" name="total_invest" class="form-control" id="editTotalInvest"
                    placeholder="Total Investment" aria-label="Total Investment" />
                </div>
                <div class="col-sm-6 mt-3">
              ...
              <div class="row">
                <div class="col-sm-12 mt-3">
                  <input type="text" name="nominee_name" class="form-control" id="editNomineeName"
                    placeholder="Nominee Name" aria-label="Nominee Name" />
                </div>
              </div>
